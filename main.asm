...
cBitOfs   = TEXT_MEM         ; WORD
cBit	  = TEXT_MEM+2       ; 4 BYTE
cXY	  = TEXT_MEM+6       ; WORD
cB	  = TEXT_MEM+8       ; 24 BYTE
cRot	  = TEXT_MEM+32      ; BYTE
flags	  = TEXT_MEM+33      ; BYTE  (0 - Quit, 1 - Update)
newXY	  = TEXT_MEM+34      ; WORD
newRot	  = TEXT_MEM+36      ; BYTE
counter   = TEXT_MEM+37      ; BYTE
next	  = TEXT_MEM+38      ; BYTE
linesflag = TEXT_MEM+39      ; BYTE
score	  = TEXT_MEM+40      ; WORD
scoreU	  = TEXT_MEM+42      ; BYTE
lines	  = TEXT_MEM+43      ; BYTE
level	  = TEXT_MEM+44      ; BYTE
string	  = TEXT_MEM+45      ; 6 BYTE
place	  = TEXT_MEM+51      ; BYTE
cNBitOfs  = TEXT_MEM+52      ; WORD
players   = TEXT_MEM+54      ; BYTE
lcounter  = TEXT_MEM+55      ; WORD
declines  = TEXT_MEM+57      ; BYTE
stlevel   = TEXT_MEM+58      ; BYTE
lastbar   = TEXT_MEM+59      ; BYTE
hsflag	  = TEXT_MEM+60      ; BYTE
scrflag   = TEXT_MEM+61      ; BYTE
gap	  = TEXT_MEM+62      ; BYTE
sbyte	  = TEXT_MEM+63      ; BYTE
sthigh	  = TEXT_MEM+64      ; BYTE
high	  = TEXT_MEM+65      ; BYTE
